...
const Header2 = () => {
  ...
  return (
    ...
    <nav className="container navbar navbar-expand-lg navbar-light max-width1" >
        <a className="codigo1 navbar-brand" href="/" style={{color : "black"}}>Codigo</a>
      <button
        style={{
      ...
      <div className="collapse navbar-collapse" id="navbarNavDropdown" style={{ flexDirection: 'column' }}>
        <ul className="navbar-nav shriti1">
        <li className="nav-link" style={{ paddingTop: '9px' }}>
            <Link className='zss eds' to="/">HOME</Link>
          </li>
          {category.map((elem) => (
